...
var tip2= d3.tip()
  ...
  .html(function(d) {
    return "<strong>Neighbourhood:</strong> <span style='color:red'>" + d.properties.neighborhood +"<br>"+ "</span>"+
           ...
           "<strong>Taxi Usage:</strong> <span style='color:red'>" +"$"+ Math.random()*30 +"<br>"+"</span>"+
           "<strong>Median Household Income:</strong> <span style='color:red'>" +"$"+ Math.random()*30 + "<br>"+"</span>"
...
console.log("there");
 ...
 queue()
    ...
    function ready(error, ny) {
      ...
      .attr("r", function(d) { return Math.sqrt(path.area(d) / Math.PI/30); })
      .on("click", clicked)
